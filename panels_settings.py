"""Settings panel for Constant Contact Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__constant_contact_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=constant_contact_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_constant_contact"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Constant Contact Settings & Accounts", level=2),
